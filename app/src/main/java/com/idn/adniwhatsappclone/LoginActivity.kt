...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_signup.setOnClickListener { // ketika text signup diklik, menjalankan fungsi onSignup
            onSignup()
        }
    }
    ...
    private fun onLogin() {
        ...
        if (edt_email.text.isNullOrEmpty()) { // check jika EditText kosong
            til_email.error = "Required Email" // TextInputLayout(till) menampilkan pesan
            til_email.isErrorEnabled = true // mengubah state till yang sebelumnya tidak
